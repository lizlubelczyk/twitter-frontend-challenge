...
const Tweet = ({ post }: TweetProps) => {
    ...
    return (
        <>
            <StyledTweetContainer>
                ...
                >
                    ...
                    {post.author.id === user?.id && (
                        <>
                            <DeletePostModal show={showDeleteModal} id={post.id} onClose={() => setShowDeleteModal(false)} />
                            <ThreeDots onClick={() => setShowDeleteModal(!showDeleteModal)} />
                        </>
                    )}
                </StyledContainer>
            ...
            {showCommentModal && (
                <CommentModal show={showCommentModal} post={actualPost} onClose={() => setShowCommentModal(false)} />
            )}
        </>
    );
};
